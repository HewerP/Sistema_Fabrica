...
namespace Sistema_de_Controle_de.Source.Model
{
    public class Laminadora:Producao
    {
        ...
        public Laminadora(int id, Data_Producao data, char turno, double quantidadeProduzida, Estoque material, double pesoEntrada, double pesoSaida, double gramaturaEntrada, double gramaturaSaida, double metragem, int tela) : base(id, data, turno, quantidadeProduzida, material)
        {
